...
namespace ValidationSample.Controllers
{
    ...
    public class ValidationController : ControllerBase
    {
        ...
        public record Post4Request([RequiredIf4("(NameType ?? ValidationSample.Controllers.NameTypes.Name) == ValidationSample.Controllers.NameTypes.Address", AllowEmptyStrings = false)] string? Name, bool? Validate, NameTypes? NameType);
